...
from data.alphaHF_data import FeatureType
from data.snapshot_expression import Operator, SnapshotExpression
...
class LookbackTimeToken(Token):
    def __init__(self, lookback_time: int) -> None:
        self.lookback_time = lookback_time

    def __str__(self): return str(self.lookback_time)
...
class ExpressionToken(Token):
    def __init__(self, expr: SnapshotExpression) -> None:
